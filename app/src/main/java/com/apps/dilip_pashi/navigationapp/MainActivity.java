package com.apps.dilip_pashi.navigationapp;
...
import com.apps.dilip_pashi.navigationapp.utilsapi.AsyncTaskDrawDirection;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bNavigation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                address = etDestination.getText().toString();
